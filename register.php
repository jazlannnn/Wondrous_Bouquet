...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Wondrous Bouquet Register Page </title>
  ...
  <body>
    ...
    <form method="POST" action="insert.php" style="margin-top:30px;">
      ...
      <p><b><h3>REGISTER PAGE</h3></b></p>
      </section>
        <div class="small-8">

      <p>For new account, please register here. If you already register, please proceed to Login Page</p>
          ...
          <div class="row">
            ...
            <div class="small-8 columns">
              <input type="text" id="right-label" placeholder="Muhammad" name="fname">
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
            ...
            <div class="small-8 columns">
              <input type="text" id="right-label" placeholder="Yazid" name="lname">
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
            ...
            <div class="small-8 columns">
              <input type="text" id="right-label" placeholder="56, Lorong F2, Kampung Melayu Seri Kundang, 48020 , Selangor" name="address">
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
            ...
            <div class="small-8 columns">
              <input type="text" id="right-label" placeholder="Rawang" name="city">
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
            ...
            <div class="small-8 columns">
              <input type="email" id="right-label" placeholder="yazidmuhammad2331@gmail.com" name="email">
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
